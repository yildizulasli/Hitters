...
df = pd.read_csv("C:\Users\yulas\Desktop\Hitters\hitters.csv",delimiter=',', quotechar='"')
print(df.head())
...
target_analys(df,"Salary","Salary")
target_analys(df,"Salary","Years")   
